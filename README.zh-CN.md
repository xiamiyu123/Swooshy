...
在标题栏上悬停后，你也可以进入专门的角落贴靠模式：

* **双指长按 `0.2s` 后再拖向角落**：进入角落贴靠模式。
* 当前悬停命中的标题栏或 Dock 目标会被短暂缓存，让连续操作时更稳定。
* 长按时长也可以稍后在 `Settings...` -> “高级设置”中自行调整。

<br>
<img src="docs/images/step3.jpg" width="600" alt="标题栏手势-角落贴靠模式" style="border-radius: 8px;">
